...
public class Parser {
    ...
    public static void Save(String path) {
        try {
            ...
            for (Ticket ticket : Printer.tickets){
                ...
                if(!ticket.getId().equals(Printer.tickets.getLast().getId())){
            ...
            com.company.Helper.Printer.WriteLine("файл не найден");
        } catch (IOException e) {
            com.company.Helper.Printer.WriteLine("ошибка работы с файлом");
        }
        ...
        try {
            ...
            while (scanner.hasNext()) {
                ...
                try {
                    ...
                    Printer.tickets.add(ticket);
                }
                catch (Exception e){
                    com.company.Helper.Printer.WriteLine("значния  либо неверные, либо недопустимые");
                }
            }
        }
        catch (FileNotFoundException e){
    ...
    public static byte[] GetResponce(Responce responce){
        try {
            ...
            com.company.Helper.Printer.WriteLine(e.getMessage());
            return null;
        }
    }
